...
| Generation models | `haseeb_typescript/types/generation.ts`, root v0/download routes | Preserves mockup, site copy, built page, provider, v0, handoff, archive, and pipeline result shapes and ordering. `WebsiteGenerationRequest` is the application input joining already-canonical form, design, plan, and uploaded-image models. |
...
- Provider SDK/HTTP response objects stay behind adapters and never enter these models.
